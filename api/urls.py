...
urlpatterns = [
    ...
    path('payments/user-payment-statement/',
         payment_views.payment_statement,
         name = 'user-payment-staement'),
    path('payments/bkash-createpayment/',
         payment_views.bkash_create_payment,
         name = 'bkash-user-createpayment'),
