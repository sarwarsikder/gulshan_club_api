# Generated by Django 3.0.6 on 2020-12-04 07:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_medium', stdimage.models.StdImageField(blank=True, null=True, upload_to='member_user/medium/')),
                ('image_thumbnail', stdimage.models.StdImageField(blank=True, null=True, upload_to='member_user/thumbnail/')),
                ('phone_primary', models.CharField(blank=True, max_length=200, null=True)),
                ('phone_secondary', models.CharField(blank=True, max_length=200, null=True)),
                ('club_ac_number', models.CharField(blank=True, max_length=200)),
                ...
                ('marital_status', models.CharField(blank=True, choices=[('Married', 'Married'), ('Unmarried', 'Unmarried'), ('Divorce', 'Divorce')], max_length=50, null=True)),
                ...
                ('opt', models.CharField(blank=True, max_length=10, null=True)),
                ('opt_time', models.DateTimeField(auto_now_add=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_medium', stdimage.models.StdImageField(blank=True, null=True, upload_to='club_facility/medium/')),
                ('image_thumbnail', stdimage.models.StdImageField(blank=True, null=True, upload_to='club_facility/thumbnail/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('image_medium', stdimage.models.StdImageField(blank=True, null=True, upload_to='event/medium/')),
                ('image_thumbnail', stdimage.models.StdImageField(blank=True, null=True, upload_to='event/thumbnail/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_medium', stdimage.models.StdImageField(blank=True, null=True, upload_to='stuff_user/medium/')),
                ('image_thumbnail', stdimage.models.StdImageField(blank=True, null=True, upload_to='stuff_user/thumbnail/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=250)),
                ('description', models.TextField()),
                ('image_medium', stdimage.models.StdImageField(blank=True, null=True, upload_to='club_facility_detail/medium/')),
                ('image_thumbnail', stdimage.models.StdImageField(blank=True, null=True, upload_to='club_facility_detail/thumbnail/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
